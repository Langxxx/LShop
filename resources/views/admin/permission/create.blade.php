        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                        {!! Form::open(['url' => '/admin/permission']) !!}
                        <div class="form-group">
                            {!! Form::label('name', '权限名称') !!}
                            {!! Form::text('name', '', ['class' => 'form-control', 'placeholder' => '列如: admin.permissions.list']) !!}
                            <p class="help-block">用于后台控制角色访问使用.</p>
                        </div>
                        <div class="form-group">
                            {!! Form::label('pid', '父级权限') !!}
                            {!! Form::select('pid', $permissions, null, ['class' => 'form-control js-example-basic-single']) !!}
                            <p class="help-block">用于后台控制角色访问使用.</p>
                        </div>
                        <div class="form-group">
