...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">LSHOP</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    {{--<li>--}}
                        {{--<a href="#"><i class="fa fa-user"></i> 权限管理<span class="fa arrow"></span></a>--}}
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                ...
                <div style="margin: 50px 0px 40px;" class="col-lg-1 col-md-1 col-sm-1">
                    @yield('pageAction')
                </div>
                <!-- /.col-lg-12 -->
            </div>
