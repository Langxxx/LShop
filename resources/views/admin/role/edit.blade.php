            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('name', $role->name, ['class' => 'form-control', 'placeholder' => '列如: admin']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('role_permission[]', $permissions, $role->permissionIDs, ['class' => 'form-control js-example-basic-multiple', 'multiple' => '"multiple"' ]) !!}
                        <p class="help-block">角色所具备的权限.</p>
                    </div>

                    <!-- Change this to a button or input when using this as a form -->
                    <a onclick="$('form').submit()" class="btn btn-success btn-block">修改角色</a>
